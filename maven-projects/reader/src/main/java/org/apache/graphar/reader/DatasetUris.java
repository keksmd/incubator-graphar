...
/** Resolves relative GraphAr metadata URIs at the graph-reader boundary. */
final class DatasetUris {
    private DatasetUris() {}

    static URI directory(URI datasetRoot) {
    ...
    static URI resolve(URI datasetRoot, URI uri) {
