...
public interface PhysicalReader {
    /** Returns the immutable set of optimizations this reader can apply physically. */
    Set<ReadCapability> capabilities();

    /**
     * Reads an operation exactly. Capabilities declined in the returned report must still be
