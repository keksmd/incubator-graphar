...
/** The vertices reached by one bounded expansion over a {@link GraphView}. */
public final class ViewTraversalResult {
    private final long[] vertices;
    private final int[] depths;
    private final boolean truncated;

    ViewTraversalResult(long[] vertices, int[] depths, boolean truncated) {
    ...
    public String toString() {
        return "ViewTraversalResult{size="
                + vertices.length
                + ", truncated="
                + truncated
                + ", frontiers="
